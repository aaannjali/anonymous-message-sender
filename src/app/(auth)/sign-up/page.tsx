...
import { Loader2, Mail, User, UserPlus, LockIcon } from 'lucide-react';
...
export default function SignUpForm() {
  ...
  return (
    <motion.div 
      ...
      className="flex justify-center items-center min-h-screen bg-gradient-to-br from-black via-gray-900 to-purple-800"
    >
